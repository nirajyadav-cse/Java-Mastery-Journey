...
- How to print results on the console.

  ## 🎯 Goal
  
  I want to become a skilled software engineer by learning every concept deeply and building projects along the way.
...
📚 What I Learned Today
 ...
 Today I continued my Java learning journey by studying variable , data types , user input , operators, and            conditional statements. I learned how Java stores data in memory using variables and how to choose the correct data   type for different kinds of information.
 I also learned how to take input from the user using the Scanner class and practiced writing programs that perform    calculations and make decisions using if , if-else, else-if, and switch statements.
